...
CREATOR_RESPONSE = (
    "## 🛠️ Ai đã tạo ra tôi?\n\n"
    "Tôi — **History Mind AI** — được xây dựng bởi **Võ Đức Hiếu** (h1eudayne), "
    "một sinh viên đam mê công nghệ AI và lịch sử Việt Nam.\n\n"
    "### 👨‍💻 Về tác giả:\n"
    "**Võ Đức Hiếu** đã thiết kế và phát triển toàn bộ hệ thống History Mind AI "
    "từ ý tưởng đến sản phẩm hoàn chỉnh, bao gồm: xây dựng bộ dữ liệu lịch sử, "
    "huấn luyện mô hình AI, và phát triển giao diện web.\n\n"
    "### 📬 Liên hệ tác giả:\n"
    "- 🐙 **GitHub**: [h1eudayne](https://github.com/h1eudayne?tab=repositories)\n"
    "- 📘 **Facebook**: [Võ Đức Hiếu](https://www.facebook.com/vo.duc.hieu2005/)\n"
    "- ✉️ **Email**: voduchieu42@gmail.com\n"
    "- 📱 **Phone**: 0915106276\n\n"
